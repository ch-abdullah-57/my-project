...
const ImageSlider3 = () => {
  ...
  return (
    <div className="min-h-screen p-8 mt-12">
      <h1 className="text-2xl font-semibold mb-8 ml-12  ">House for Sale in Lahore( 9929 properties available )</h1>
     ...
     <div> 
      ...
      <h1 className='text-green-400 mt-10 text-2xl font-bold ml-12 cursor-pointer '>Houses Available for Sale in Lahore</h1>
      ...
      {/*  */}
      <h1 className='text-gray-500 mt-10 text-2xl ml-12 '>Price Trends of Houses for Sale In Lahore      </h1>
      ...
      {/*  */}
      <h1 className='text-gray-500 mt-10 text-2xl  ml-12'>Facilities in Lahore     </h1>
